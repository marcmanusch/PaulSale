...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a id="test" class="navbar-brand" href="#">Rabatte</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li{if {controllerAction} === 'index'} class="active"{/if}><a
                            href="{url controller="PaulSaleBackendController" action="index" __csrf_token=$csrfToken}">Anlegen</a>
                </li>
                <li{if {controllerAction} === 'list'} class="active"{/if}><a
                            href="{url controller="PaulSaleBackendController" action="list" __csrf_token=$csrfToken}">Laufende Rabatte</a>
                </li>
